...
class S {
  ...
  /// `Michael Page`
  String get michaelPageTitle {
    return Intl.message(
      'Michael Page',
      name: 'michaelPageTitle',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Alex Page`
  String get alexPageTitle {
    return Intl.message('Alex Page', name: 'alexPageTitle', desc: '', args: []);
  }

  /// `Den Page`
  String get denPageTitle {
    return Intl.message('Den Page', name: 'denPageTitle', desc: '', args: []);
  }
}
